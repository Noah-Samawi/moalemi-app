...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "dashboard.noChannel": "لا يوجد غرفة صف افتراضي لهذا الدرس بعد",
    "dashboard.joinError": "تعذر الانضمام للدرس. حاول مرة أخرى.",
    "dashboard.welcomeBack": "مرحباً بعودتك إلى لوحة التحكم",
    "dashboard.upcomingShort": "القادمة",
    "dashboard.noLessonsHint": "احجز درساً مع معلم للبدء",
    "dashboard.user": "مستخدم",
    "dashboard.classroom": "الفصل الافتراضي",
  ...
  en: {
    ...
    "dashboard.noChannel": "No virtual classroom for this lesson yet",
    "dashboard.joinError": "Could not join lesson. Please try again.",
    "dashboard.welcomeBack": "Welcome back to your learning dashboard",
    "dashboard.upcomingShort": "Upcoming",
    "dashboard.noLessonsHint": "Book a lesson with a teacher to get started",
    "dashboard.user": "User",
    "dashboard.classroom": "Virtual Classroom",
    "dashboard.home": "Home",
  ...
  de: {
    ...
    "dashboard.noChannel": "Noch kein virtuelles Klassenzimmer für diese Stunde",
    "dashboard.joinError": "Konnte der Stunde nicht beitreten. Bitte versuchen Sie es erneut.",
    "dashboard.welcomeBack": "Willkommen zurück in Ihrem Lern-Dashboard",
    "dashboard.upcomingShort": "Bevorstehend",
    "dashboard.noLessonsHint": "Buchen Sie eine Stunde mit einem Lehrer, um zu beginnen",
    "dashboard.user": "Benutzer",
    "dashboard.classroom": "Virtuelles Klassenzimmer",
